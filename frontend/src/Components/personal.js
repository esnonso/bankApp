    ...
    return(
        ...
        <div className="panel panel-default">
            ...
            <div className="panel-body">
               ...
               <p>Fresno County Bank makes applying for a personal loan quick, easy and convenient. We offer a variety of 
            ...
            <Container className="text-center container-footer">
                <p>
                Fresno County Bank is fantastic! The people there explain everything so clearly, they are concise, efficient and friendly.
